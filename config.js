...
const prefix = 'alloy_' //Community token name for Custom Json IDs
const TOKEN = 'ALLOY' //Token name
const precision = 3 //precision of token
const tag = 'alloyxuast' //the fe.com/<tag>/@<leader>/<permlink>
const jsonTokenName = 'alloy' //what customJSON in Escrows and sends is looking for
...
const msPubMemo = 'INSERTHERE' //memo key for msaccount
const msPriMemo = 'INSERTHERE'
const msmeta = ''
const mainAPI = 'token.alloyxuast.tk' //leaders API probably
const mainRender = 'alloydata.alloyxuast.tk' //data and render server
